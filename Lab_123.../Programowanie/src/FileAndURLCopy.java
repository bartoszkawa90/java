...
public class FileAndURLCopy {
    ...
    public static void main(String[] args) {
        ...
        //  DZIAŁANIE Z URL == ZAPISYWANIE DO PLIKU  html
        try{
            System.out.print("[URL]     ");
            URL url = new URL(args[0]);
            InputStream stream = url.openStream();
            BufferedReader readURL = new BufferedReader(new InputStreamReader(stream));
            String line;
...
//                    throw new FileNotFoundException("Plik nie istnieje");
        ...
        //   ZWYKŁE DZIAŁANIE == PODAWANIE PLIKU Z TEKSTEM DO SKOPIOWANIA
        catch (MalformedURLException ext){
            System.err.println("Podany adres URL " + args[0] + " jest nieprawidłowy");
